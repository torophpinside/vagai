...
// crawler, bloqueando endereços de rede privada/loopback/link-local e esquemas
// não-HTTP (mitigação de SSRF). Hosts são resolvidos por DNS e todos os IPs
// retornados são verificados.
